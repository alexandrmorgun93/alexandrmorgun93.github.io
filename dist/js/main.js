...
(() => {
    ...
    if (slider !== null) {
        (__webpack_require__(3))(slider, dotsWrap, arrDote, yak, timer, nextSlide, prevSlide);
    }
    ...
    if (popupBtn !== null) {
        (__webpack_require__(5))(popupBtn, popup, popupText, popupClose);
    }
    ...
    let moveTitle = __webpack_require__(6);
    window.addEventListener('scroll', () => {
    ...
    let slick = __webpack_require__(8);
    ...
    if (packages !== null) {
        (__webpack_require__(9))(packages);
    }
    ...
    window.addEventListener('scroll', () => {
        ...
        if (countersWrap !== null && countersWrap.getBoundingClientRect().top - window.innerHeight * .8 < 0 && counterYak) {
            counterYak = false;
            let moveCounter = __webpack_require__(10);
    ...
    if (tabList !== null) {
        (__webpack_require__(11))(tabList, tabElement);
    }
...
let random = __webpack_require__(7);
let direction = 1;
